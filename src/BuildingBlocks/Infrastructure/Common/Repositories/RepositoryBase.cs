    ...
    where TContext : DbContext
{
    ...
    {
        IQueryable<T> items = tracking ? _context.Set<T>() : _context.Set<T>().AsNoTracking();
    ...
    public IQueryable<T> FindAll(Expression<Func<T, bool>>? predicate, bool tracking, Func<IQueryable<T>, IQueryable<T>>? include = null)
    {
        IQueryable<T> query = tracking ? _context.Set<T>() : _context.Set<T>().AsNoTracking();
    ...
    public async Task<T> FindSingleAsync(Expression<Func<T, bool>>? predicate = null,
